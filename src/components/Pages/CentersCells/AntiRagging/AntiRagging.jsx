...
function AntiRagging() {
  ...
  return (
    <>
      <Box maxWidth={maxWidth} mx={"auto"} p={"3%"} bgcolor={"#fff"} mt={7} borderRadius={4} className="smooth-shadow" textAlign={"justify"}>
        <h2 className='fw-bold color-secondary'>Implementation of UGC Regulations to Combat Ragging in Higher Educational Institutions</h2>
      ...
      <Box maxWidth={maxWidth} mx={"auto"} p={"3%"} bgcolor={"#fff"} mt={7} borderRadius={4} className="smooth-shadow" textAlign={"justify"}>
        <h2 className='fw-bold color-secondary mb-0'>Legal Measures and Disciplinary Actions for Ragging</h2>
        <h4 className='fw-semibold mb-3 '>Ragging is a criminal offense. Ragging is strictly prohibited by both State Govt. and Central Govt. Punishment for ragging will be as follows</h4>
        <Box m={1}>
      ...
      <Box maxWidth={maxWidth} mx={"auto"} p={"3%"} bgcolor={"#fff"} mt={7} borderRadius={4} className="smooth-shadow" textAlign={"justify"}>
        <h2 className='fw-bold color-secondary mb-0'>Objectives Of Anti Ragging Committee</h2>
        <h4 className='fw-semibold mb-3 '>Anti-Ragging Committee will be the supervisory and advisory committee in preserving a Culture of Ragging Free Environment in the university Campus. The main objectives of this cell are as follows</h4>
        <Box m={1}>
      ...
      <Box maxWidth={maxWidth} mx={"auto"} p={"3%"} bgcolor={"#fff"} mt={7} borderRadius={4} className="smooth-shadow" textAlign={"justify"}>
        <h2 className='fw-bold color-secondary mb-0'>Functions of the Ragging Committee</h2>
      ...
      <Box maxWidth={maxWidth} mx={"auto"} p={"3%"} bgcolor={"#fff"} mt={7} borderRadius={4} className="smooth-shadow">
        <h2 className='fw-bold color-secondary'>Composition of Committees for Ragging Prevention and Response</h2>
      ...
      <Box maxWidth={maxWidth} mx={"auto"} p={"3%"} bgcolor={"#fff"} mt={7} borderRadius={4} className="smooth-shadow">
        <h2 className='fw-bold color-secondary'>Male Squad For Anti Ragging</h2>
      ...
      <Box maxWidth={maxWidth} mx={"auto"} p={"3%"} bgcolor={"#fff"} mt={7} borderRadius={4} className="smooth-shadow">
        <h2 className='fw-bold color-secondary'>Female Squad For Anti Ragging</h2>
        <table style={{ width: "100%" }}>
          <thead style={{}} className='text-white'>
            <th className='p-2 fs-5 border-5 border-white  text-uppercase' style={{ letterSpacing: "1px", background: "#264796", borderRadius: "10px" }}>Committee Composition	</th>
            <th className='p-2 fs-5 border-5 border-white  text-uppercase' style={{ letterSpacing: "1px", background: "#264796", borderRadius: "10px" }}>Designation	</th>

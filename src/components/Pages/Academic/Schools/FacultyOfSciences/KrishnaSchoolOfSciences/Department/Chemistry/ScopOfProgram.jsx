  ...
  return (
    <Box borderRadius={4} >
      ...
      <Stack direction={"row"} gap={2} flexWrap={"wrap"}>
        <Button variant="text" className="fw-bold border-2 smooth-shadow-card" color="secondary">Chemist</Button>
        <Button variant="text" className="fw-bold border-2 smooth-shadow-card" color="secondary">Pharmacy Assistant</Button>
        <Button variant="text" className="fw-bold border-2 smooth-shadow-card" color="secondary">Lab Assistant</Button>
        <Button variant="text" className="fw-bold border-2 smooth-shadow-card" color="secondary">Toxicologist</Button>
        <Button variant="text" className="fw-bold border-2 smooth-shadow-card" color="secondary">Biochemists</Button>
        <Button variant="text" className="fw-bold border-2 smooth-shadow-card" color="secondary">School Teacher</Button>
      </Stack>

      <h4 className="text-uppercase color-secondary fw-bold mt-4">Certificate Course</h4>
      <Stack direction={"row"} gap={2} flexWrap={"wrap"}>
        <Button variant="text" className="fw-bold border-2 smooth-shadow-card" color="secondary">Chemical Labs</Button>
        ...
        <Button variant="text" className="fw-bold border-2 smooth-shadow-card" color="secondary">Cosmetics and Perfume Industry</Button>
        <Button variant="text" className="fw-bold border-2 smooth-shadow-card" color="secondary">Military Hospitals</Button>
        <Button variant="text" className="fw-bold border-2 smooth-shadow-card" color="secondary">Fertilizer Plants</Button>
        <Button variant="text" className="fw-bold border-2 smooth-shadow-card" color="secondary">Energy Firms</Button>

...
function VisionAndMission() {
  const MissionList = [
    ...
    "Fruitage knowledgeable graduates for careers in academia, industry and GOs/NGOs. Promote an ethical and professional environment amongst faculties and students of the department.",
  ];
